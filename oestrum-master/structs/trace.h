...
public:
	...
	void TraceRay_NEWEST(const Ray_t &ray, unsigned int fMask, ITraceFilter* pTraceFilter, CGameTrace* pTrace)
	{
		typedef void(__thiscall* oTraceRay)(void*, const Ray_t&, unsigned int, ITraceFilter*, CGameTrace*);
		getvfunc<oTraceRay>(this, 5)(this, ray, fMask, pTraceFilter, pTrace);
	}
	void ClipRayToCBaseEntity(const Ray_t& ray, unsigned int nMask, CBaseEntity* pCBaseEntity, CGameTrace* pTrace)
	{
		typedef void(__thiscall* oClipRayToTrace)(PVOID, const Ray_t&, unsigned int, CBaseEntity*, CGameTrace*);
