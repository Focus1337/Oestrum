...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
	...
	auto color_black = ImGui::GetColorU32(ImVec4(0.1f, 0.1f, 0.1f, 0.45f));
	auto color_main = ImGui::GetColorU32((hovered && held) ? ImGuiCol_ButtonActive : hovered ? ImGuiCol_ButtonHovered : ImGuiCol_Button);

	window->DrawList->AddRect(bb.Min, bb.Max, GetColorU32(ImVec4(0.6f, 0.6f, 0.6f, 1.0f)));
	window->DrawList->AddRectFilledMultiColor(bb.Min, bb.Max, color_main, color_main, color_black, color_black);
...
bool ImGui::SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags)
{
	...
	auto color_black = ImGui::GetColorU32(ImVec4(0.1f, 0.1f, 0.1f, 0.45f));
	auto color_main = GetColorU32(g.ActiveId == id ? ImGuiCol_SliderGrabActive : ImGuiCol_SliderGrab);
	auto color_sss = GetColorU32(ImGuiCol_FrameBg);

	// Draw frame
	RenderFrame(frame_bb.Min, frame_bb.Max, GetColorU32(ImGuiCol_FrameBg), true, style.FrameRounding);
	window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, GetColorU32(ImVec4(0.6f, 0.6f, 0.6f, 1.0f)));
	window->DrawList->AddRectFilledMultiColor(frame_bb.Min, frame_bb.Max, color_sss, color_sss, color_black, color_black);
	...
	window->DrawList->AddRectFilledMultiColor(frame_bb.Min, grab_bb.Max, color_main, color_main, color_black, color_black);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	auto color_black = ImGui::GetColorU32(ImVec4(0.1f, 0.1f, 0.1f, 0.45f));
	auto color_main = GetColorU32(ImGuiCol_CheckMark);
	auto color_dis = GetColorU32((held && hovered) ? ImGuiCol_FrameBgActive : hovered ? ImGuiCol_FrameBgHovered : ImGuiCol_FrameBg);

	RenderFrame(check_bb.Min, check_bb.Max, GetColorU32((held && hovered) ? ImGuiCol_FrameBgActive : hovered ? ImGuiCol_FrameBgHovered : ImGuiCol_FrameBg), true, style.FrameRounding);
	window->DrawList->AddRect(check_bb.Min, check_bb.Max, GetColorU32(ImVec4(0.6f, 0.6f, 0.6f, 1.0f)));
	window->DrawList->AddRectFilledMultiColor(check_bb.Min, check_bb.Max, color_dis, color_dis, color_black, color_black);
	...
	if (*v)
	{
		...
		window->DrawList->AddRectFilledMultiColor(check_bb.Min, check_bb.Max, color_main, color_main, color_black, color_black);
	}
...
bool ImGui::Combo(const char* label, int* current_item, bool(*items_getter)(void*, int, const char**), void* data, int items_count, int height_in_items)
{
	...
	//RenderCollapseTriangle(ImVec2(frame_bb.Max.x - arrow_size, frame_bb.Min.y) + style.FramePadding, true);
	auto color_black = ImGui::GetColorU32(ImVec4(0.1f, 0.1f, 0.1f, 0.45f));
	auto color_main = GetColorU32(popup_open || hovered ? ImGuiCol_ButtonHovered : ImGuiCol_Button);
	window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, GetColorU32(ImVec4(0.6f, 0.6f, 0.6f, 1.0f)));
	window->DrawList->AddRectFilledMultiColor(frame_bb.Min, frame_bb.Max, color_main, color_main, color_black, color_black);
